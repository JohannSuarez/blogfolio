          ...
          <section>
            ...
            <div class="row_set">
              ...
              <p>
                ...
                components can recognize. The Plotly Dash components are then refreshed and then the end result is a webpage with components that graphed realtime sensor data.
            ...
            <p class="clearfix sole_paragraph">
              ...
              <p class="clearfix sole_paragraph">These limitations were beyond the scope of the contract I finished. However, I took a crack at addressing them
              ...
              <ul>
                <li><b>ESP32</b> - An inexpensive yet powerful microcontroller, used for receiving the pH sensor's values, storing calibration offsets, and sending the pH values back to the Raspberry Pi through WiFi.</li>
                <li><b>4x4 Matrix Membrane Keypad</b> - For going into calibration mode, an ESP32 thread waited for a sequence of key presses (ex: "C" then "A")</li>
                <li><b>pH-4052 Module</b> - Module for measuring pH levels. It receives an analog voltage from a pH probe and converts it into readable pH values. </li>
                <li><b>128 x 64 0.91" OLED Display</b> - Regularly displays the pH reading, warns of network issues, and also guides user through calibration mode.</li>
                <li><b>3D Printed PLA Case</b> - I 3D modelled a housing to hold all of the components together.</li>
            ...
            <p class="clearfix sole_paragraph">
            The planned implementation had one of these units mounted above each water tank.

            The WiFi communication offered by the ESP32 meant voltage interference from having long physical
            wires were no longer an issue. With an HTTP server running locally on each Raspberry Pi, each ESP32
            unit can communicate via HTTP POST to their designated Arduino to report their current pH reading.

            If a unit needed its pH sensor probe's weekly calibration, one simply keys in "C" and "A". The OLED display then instructs the 
            user to dip the pH probe in two diffent pH levels, and afterwards automatically calculates the offset, and saves the offset
            ...
            <div class="row_set">
              <figure class="cap-bot">
                <img alt="completed pH sensor kit setup" width="855" className="irl_ph_sensor"
                  src='https://i.imgur.com/KwyLlw4.jpg'
                />
                <figcaption>
                  Actual implementation. At the time I had no 128x64 OLED, so I used a 128x32
                </figcaption>
              </figure>

              <figure class="cap-bot">
                <img alt="planned_esp32_implementation" src="https://i.imgur.com/eWHdzNH.jpg"/>
                <figcaption>
                  The pH reading and calibration is modularized and physically separated from the Arduino.
                </figcaption>
              </figure>
            ...
            <p class="clearfix sole_paragraph">
              A great feature of my pH reading unit is it allowed anyone to view the current pH reading of an algae tank without
              needing to walk back to the desktop monitor. I designed it to function within the lab's system and also completely independently.
              Relying on a ESP32 board, it can be powered by just a 5v power bank. Lastly, it will display the pH data through the OLED even before
              having successfully connected to the algae farm's local area network.
            </p>
      ...
      <BlogPostCard className="face_tracking_webcam">
        <article>
          <header>
            ...
            <p>By <span class="author">Johann Suarez</span> on <time datetime="YYYY-MM-DD">August 20, 2020</time></p> 
          </header>
          <h3>No need for computationally heavy AI, the Viola-Jones algorithm can do the job.</h3>
      ...
      <BlogPostCard className="project1">
        <article>
          ...
          <header>
            ...
            <p>By <span class="author">Johann Suarez</span> on <time datetime="YYYY-MM-DD">May 21, 2020</time></p> 
          </header>

          <section>
            <p>
              <h3>For the purpose of colorizing black and white films without painstakingly handpainting each frame.</h3>
              <h3>Under Construction. Stay tuned! </h3>
              <h3>In the meantime, see: <a href="https://github.com/JohannSuarez/chroma_blend">ChromaBlend on Github</a></h3>
            </p>
            <div class="row_set">
